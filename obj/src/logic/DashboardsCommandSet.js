...
class DashboardsCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetDashboardsCommand() {
        return new pip_services3_commons_node_2.Command("get_dashboards", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetDashboardCommand() {
        return new pip_services3_commons_node_2.Command("get_dashboard", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('user_id', pip_services3_commons_node_6.TypeCode.String)
            .withRequiredProperty('app', pip_services3_commons_node_6.TypeCode.String)
            .withOptionalProperty('kind', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeSetDashboardCommand() {
        return new pip_services3_commons_node_2.Command("set_dashboard", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeDeleteDashboardsCommand() {
        return new pip_services3_commons_node_2.Command("delete_dashboards", new pip_services3_commons_node_5.ObjectSchema(true)
