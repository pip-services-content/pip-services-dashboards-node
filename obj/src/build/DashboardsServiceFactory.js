...
class DashboardsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
DashboardsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-dashboards", "factory", "default", "default", "1.0");
DashboardsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-dashboards", "persistence", "memory", "*", "1.0");
DashboardsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-dashboards", "persistence", "file", "*", "1.0");
DashboardsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-dashboards", "persistence", "mongodb", "*", "1.0");
DashboardsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-dashboards", "controller", "default", "*", "1.0");
DashboardsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-dashboards", "service", "seneca", "*", "1.0");
DashboardsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-dashboards", "service", "http", "*", "1.0");
